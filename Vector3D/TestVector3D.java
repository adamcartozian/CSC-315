...
System.out.println(v0 + " is parallel to " + v0 + " is " +
v0.Parallel(v0));
System.out.println(v0 + " is parallel to " + v1 + " is " +
v0.Parallel(v1));
v0 = new Vector3D(1, 0, 0);
v1 = new Vector3D(-1, 0, 0);
System.out.println(v0 + " is anti-parallel to " + v0 + " is " +
v0.AntiParallel(v0));
System.out.println(v0 + " is anti-parallel to " + v1 + " is " +
v0.AntiParallel(v1));
System.out.println(v0 + " == " + v0 + " is " + v0.equals(v0));
System.out.println(v0 + " == " + v1 + " is " + v0.equals(v1));
v0 = new Vector3D(2, -3, 4);
v1 = new Vector3D(5, 2, 1);
System.out.println("project of " + v0 + " onto " + v1 + " = " +
v0.Projection(v1));
}
}
